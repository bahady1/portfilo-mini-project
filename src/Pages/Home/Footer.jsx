      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/bahadyi2"
            ...
            <li>
              <a
                href="https://www.instagram.com/_bahady/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/bahady5"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/abdelhadi-lakaf-b1495b251/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
